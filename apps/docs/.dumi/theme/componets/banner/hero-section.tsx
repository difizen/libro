...
export const HeroSection: React.FC = () => {
  ...
  return isMobile ? (
    <div className="mb-16 from-zinc-50 to-white dark:from-zinc-950 to-black relative">
      ...
      <div className="max-w-7xl mx-auto px-8 sm:px-6 lg:px-8 py-8 sm:py-24 lg:py-32 relative z-10">
        <div className="max-w-3xl">
          <p className="text-base sm:text-2xl text-muted-foreground mb-4 mt-6">
            {l10n.t(
              'Flexible customization and easy integration of Notebook product solutions.',
            )}
          </p>
        </div>
        <img
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32 relative z-10">
        <div className="max-w-3xl">
          ...
          <Button
            ...
            size="large"
            className="start-btn"
            href="http://libro-lab.difizen.net/libro?"
            target="_blank"
          >
            Start now
          </Button>
          <Button
            ...
            onClick={() => copy2clipboard('pip install libro')}
          >
            pip install libro
          </Button>
        </div>
