      ...
      <Row className="user-container">
        ...
        <Col sm={12} md={8} lg={6}>
          <div className="user-item">
            <img className="user-item-img" src="/cloudlab.png"></img>
          </div>
        </Col>
        <Col sm={12} md={8} lg={6}>
          <a
            className="user-item"
            href="https://opensumi.com"
            target="_blank"
            rel="noreferrer"
          >
            <img className="user-item-img user-item-img-sm" src="/opensumi.png"></img>
          </a>
        </Col>
      </Row>
    </div>
