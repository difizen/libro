...
export const initKernelPanelColorToken = () => {
  registerColor(
    ...
    localize(
      'kernel.panel.collapse.header.label',
      'the collapse header label of kernel panel',
    ),
    true,
  );
  ...
  registerColor(
    ...
    localize(
      'kernel.panel.collapse.item',
      'the collapse item color of kernel panel',
    ),
    true,
  );
  ...
  registerColor(
    ...
    localize(
      'kernel.panel.collapse.item.hover',
      'the collapse item hover color of kernel panel',
    ),
    true,
  );
  ...
  registerColor(
    ...
    localize(
      'kernel.panel.collapse.header.close.all',
      'the close all color of kernel panel',
    ),
    true,
  );
