...
> {
  ...
  protected registerLanguageProvider(
  ...
  ): [vscode.Disposable, SemanticTokensProviderShape] {
    ...
    const documentProvider: vscode.DocumentSemanticTokensProvider | undefined =
      fullProvider
        ? {
            ...
            provideDocumentSemanticTokens: (document, token) => {
              ...
              const provideDocumentSemanticTokens: DocumentSemanticsTokensSignature = (
                ...
                return client
                  .sendRequest(SemanticTokensRequest.type, params, token)
                  .then(
                    (result) => {
    ...
    const rangeProvider: vscode.DocumentRangeSemanticTokensProvider | undefined =
      hasRangeProvider
        ? {
            provideDocumentRangeSemanticTokens: (
              document: vscode.TextDocument,
